    ...
    <div className="flex items-center justify-center min-w-fit">
      ...
      <div className="py-14 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
            <div className="flex justify-start item-start space-y-2 flex-col">
                <h1 className="text-lg md:text-3xl text-white lg:text-4xl font-semibold leading-7 lg:leading-9 ">Order #{orderId.slice(-6)}</h1>
                <p className="text-sm md:text-base text-gray-300 font-medium leading-6">{date} at {time} </p>
            </div> 
            <div className="mt-10 flex flex-col xl:flex-row jusitfy-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
                <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
                    <div className="flex flex-col justify-start items-start bg-stone-900  px-4 py-4 md:py-6 md:p-6 xl:p-8 w-64 md:w-full">
                        ...
                        {orderDetails?.orderItems && orderDetails?.orderItems?.map((oi)=>{
                          return(
                            ...
                            <div className="pb-4 md:pb-8 w-full md:w-40">
                                <img className="w-full  h-48 md:h-32" src={oi.image} alt={oi.name} />
                            ...
                            <div className="border-b border-pink-600 md:flex-row flex-col flex justify-between items-start w-full pb-8 space-y-4 md:space-y-0">
                                ...
                                <div className="flex justify-between space-x-8 items-start w-full">
                                    ...
                                    <p className="text-base text-white xl:text-lg leading-6 ">x {oi.quantity}</p>
                    ...
                    <div className="flex justify-center flex-col md:flex-row  items-stretch w-64 md:w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
                ...
                <div className=" bg-stone-900 w-64 md:w-full xl:w-96 flex justify-between items-center md:items-start px-4 py-6 md:p-6 xl:p-8 flex-col">
